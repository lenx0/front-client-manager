...
import { AppBar, Toolbar, Typography, InputBase, IconButton, Badge, Avatar, Grid } from '@mui/material';
        ...
        <Grid container alignItems="center">
          ...
          <Grid item xs={2}>
            <Typography variant="h6" noWrap>
              <img width={100} height={100} src="/images/bendy-call-user-window.png"/>
            </Typography>
          </Grid>
          <Grid item xs={8}>
